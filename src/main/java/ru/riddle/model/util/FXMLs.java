...
public enum FXMLs {
    ...
    THEORY_SECOND_EXAMPLE_1("/view/theory/examples/secondTask/TheorySecondExample1.fxml", "SecondExample1"),
    THEORY_SECOND_EXAMPLE_2("/view/theory/examples/secondTask/TheorySecondExample2.fxml", "SecondExample2"),
    THEORY_SECOND_EXAMPLE_3("/view/theory/examples/secondTask/TheorySecondExample3.fxml", "SecondExample3"),
    THEORY_SECOND_EXAMPLE_4("/view/theory/examples/secondTask/TheorySecondExample4.fxml", "SecondExample4"),
    ;
